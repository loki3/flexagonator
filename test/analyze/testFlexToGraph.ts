namespace Flexagonator {
  ...
  describe('getStateToStateTree', () => {
    it('should create a tree starting with state 0', () => {
      const relFlexes1: RelativeFlexes = [];
      relFlexes1.push(new RelativeFlex(0, false, 'S', 1));
      relFlexes1.push(new RelativeFlex(2, false, 'T', 2));
      relFlexes1.push(new RelativeFlex(0, true, "^T'", 2));
      ...
      const relFlexes3: RelativeFlexes = [];
      relFlexes3.push(new RelativeFlex(3, true, 'T', 0));
      relFlexes3.push(new RelativeFlex(0, false, 'S', 3));
      const relFlexes4: RelativeFlexes = [];
      relFlexes4.push(new RelativeFlex(2, false, 'T', 0));

      // should get [0->1, 0->2], [], [2->3]
      const result = getStateToStateTree([relFlexes1, relFlexes2, relFlexes3, relFlexes4]);
