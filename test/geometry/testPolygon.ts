namespace Flexagonator {
  ...
  describe('getCorners.angles', () => {
    it('should use angles properly', () => {
      ...
      expect(corners[1]).toBeCloseTo(126.8, 0.1);
      expect(corners[2]).toBeCloseTo(29.3, 0.1);
      expect(corners[3]).toBeCloseTo(170.7, 0.1);
      expect(corners[4]).toBeCloseTo(73.2, 0.1);
      expect(corners[5]).toBeCloseTo(73.2, 0.1);
      expect(corners[6]).toBeCloseTo(170.7, 0.1);
